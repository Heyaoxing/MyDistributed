...
namespace Common.RedisHelper
{
    public class RedisUtils
    {
        ...
        private static readonly string DefaultHost = ConfigurationManager.AppSettings["JobServer_Host"]; // "127.0.0.1";
        private static readonly int DefaultPort = Int32.Parse(ConfigurationManager.AppSettings["JobServer_Post"]); //6379
        private static readonly int DefaultDb = Int32.Parse(ConfigurationManager.AppSettings["JobServer_Db_Index"]); //1
